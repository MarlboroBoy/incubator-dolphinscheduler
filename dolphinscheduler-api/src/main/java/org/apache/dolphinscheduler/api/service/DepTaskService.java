...
public interface DepTaskService {
    ...
    Map<String, Object> queryDepTaskList(User loginUser, String projectName,String seachVal);
    ...
    Map<String, Object> updateTaskDefinition(User loginUser, String projectName, DepTask depTask);
}
