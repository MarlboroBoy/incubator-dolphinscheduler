...
public class DepProcessBuild {
   ...
   */
  public DepProcessBuild(List<Task> tasks, List<Property> globalParams) {
    this.tasks = tasks;
  ...
  public boolean equals(Object o) {
    ...
    DepProcessBuild that = (DepProcessBuild) o;
